 ...
 *    fill, text, collideRectRect, round, random, loop, noLoop, key
 */

let backgroundColor, playerSnake, currentApple, score, player2Snake;
let Apples
...
function draw() {
  ...
  player2Snake.moveSelf();
  player2Snake.showSelf();
  player2Snake.checkCollisions();
  player2Snake.checkApples();
